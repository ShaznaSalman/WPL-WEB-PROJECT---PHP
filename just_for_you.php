...
?>
<!?php
$subtotalValue = isset($_GET['subtotalValue']) ? $_GET['subtotalValue'] : 0;
echo "Subtotal Value: " . $subtotalValue; // Debugging output
$deliveryCost = 300.00;
$grandTotal = $subtotalValue + $deliveryCost;
?>
<!?php
...
<body>
   ...
   <div class="form">
      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-4">
               <div class="containForm">
                  ...
                  <input type="radio" class="deliver" name="deliver" value="yes">Yes<br>
                  <input type="radio" class="deliver" name="deliver" value="no">No<br><br>
               ...
               <div class="deliveryform">
                  <div class="containForm">
                     ...
                     <form action="" method="post">
                        ...
                        <label>COUNTRY</label>
                        <input type="text" class="country" placeholder="Enter Country"><br>
         ...
         <button type="click" class="confirmDet" id="confirmDet">CONFIRM ORDER</button><br>
      </div>
   </div>
         ...
         <p class="herep">Grand Total:<span style="font-weight: bold; color: brown;" id="grandTotal">Rs. <!?php echo $grandTotal; ?></span></p-->
            <!--table class="order-summary-table">
               ...
               <tr>
                  ...
                  <td colspan="2"><span style="font-weight: 400;" id="subTotD">Rs. <!?php echo $subtotalValue; ?></span></td>
         ...
         <p class="herep">Grand Total: <span style="font-weight: bold; color: brown;" id="subTotC"></span></p-->
            ...
            <!--table class="order-summary-table">
               ...
               <tr>
                  ...
                  <td colspan="2"><span style="font-weight: bold; color: brown;" id="subTotC">Rs. <!?php echo $subtotalValue; ?></span></td>
   ...
   <script>
      // Storing subtotal value in local storage

      var passedValue = localStorage.getItem("totalPrice");
      ...
      var subtotalValue = <!?php echo $subtotalValue; ?>;
      var deliveryCost = 300.00;
      var grandTotal = subtotalValue + deliveryCost;

      // Debugging output
      console.log("Subtotal Value in JavaScript: " + subtotalValue);
      console.log("Grand Total in JavaScript: " + grandTotal);
   </script>
